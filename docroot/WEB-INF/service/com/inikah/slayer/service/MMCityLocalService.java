...
/**
 * Provides the local service interface for MMCity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ahmed Hasan
 * @see MMCityLocalServiceUtil
...
public interface MMCityLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MMCityLocalServiceUtil} to access the m m city local service. Add custom service methods to {@link com.inikah.slayer.service.impl.MMCityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
