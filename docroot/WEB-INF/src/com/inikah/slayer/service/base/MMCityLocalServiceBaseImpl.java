...
import com.inikah.slayer.service.MMCityLocalService;
...
/**
 * Provides the base implementation for the m m city local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.inikah.slayer.service.impl.MMCityLocalServiceImpl}.
 * </p>
 *
 * @author Ahmed Hasan
 ...
 * @generated
 */
public abstract class MMCityLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MMCityLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.inikah.slayer.service.MMCityLocalServiceUtil} to access the m m city local service.
	 */
	...
	@Override
	public MMCity addMMCity(MMCity mmCity) throws SystemException {
		mmCity.setNew(true);

		return mmCityPersistence.update(mmCity);
	}
	 ...
	 */
	@Override
	public MMCity createMMCity(long cityId) {
		return mmCityPersistence.create(cityId);
	}
	...
	@Override
	public MMCity deleteMMCity(long cityId)
		throws PortalException, SystemException {
		return mmCityPersistence.remove(cityId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MMCity deleteMMCity(MMCity mmCity) throws SystemException {
		return mmCityPersistence.remove(mmCity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(MMCity.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return mmCityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return mmCityPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return mmCityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return mmCityPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public MMCity fetchMMCity(long cityId) throws SystemException {
		return mmCityPersistence.fetchByPrimaryKey(cityId);
	}
	 ...
	 */
	@Override
	public MMCity getMMCity(long cityId)
		throws PortalException, SystemException {
		return mmCityPersistence.findByPrimaryKey(cityId);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return mmCityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MMCity> getMMCities(int start, int end)
		throws SystemException {
		return mmCityPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getMMCitiesCount() throws SystemException {
		return mmCityPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MMCity updateMMCity(MMCity mmCity) throws SystemException {
		return mmCityPersistence.update(mmCity);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.inikah.slayer.model.MMCity",
			mmCityLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"com.inikah.slayer.model.MMCity");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = mmCityPersistence.getDataSource();
	...
	private MMCityLocalServiceClpInvoker _clpInvoker = new MMCityLocalServiceClpInvoker();
}